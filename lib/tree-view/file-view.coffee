...
class FileView extends HTMLElement
  initialize: (@file) ->
    ...
    iconClass = FileIcons.getService().iconClassForPath(@file.path, "proj-view")
    if iconClass
...
module.exports = document.registerElement('proj-view-file', prototype: FileView.prototype, extends: 'li')
