...
class RootDragAndDropHandler
  ...
  handleEvents: ->
    ...
    @treeView.on 'dragenter', '.proj-view', @onDragEnter
    @treeView.on 'dragend', '.project-root-header', @onDragEnd
    @treeView.on 'dragleave', '.proj-view', @onDragLeave
    @treeView.on 'dragover', '.proj-view', @onDragOver
    @treeView.on 'drop', '.proj-view', @onDrop
