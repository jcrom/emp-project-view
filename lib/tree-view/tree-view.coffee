...
class TreeView extends View
  ...
  @content: ->
      @div class: 'proj-view-scroller order--center', outlet: 'scroller', =>
  ...
  initialize: (state) ->
    ...
    console.log "state.selectedPath:", state.selectedPath
  ...
  serialize: ->
    directoryExpansionStates: new ((roots) ->
      # console.log "serialize roots:", roots
  ...
  handleEvents: ->
    @on 'dblclick', '.proj-view-resize-handle', =>
      @resizeToFitContent()
    @on 'click', '.entry', (e) =>
    ...
    @on 'mousedown', '.entry', (e) =>
      ...
      @onMouseDown(e)
    @on 'mousedown', '.proj-view-resize-handle', (e) =>
      console.log "do mousedown else"
      @resizeStarted(e)
