...
class DirectoryView extends HTMLElement
  initialize: (@directory) ->
    # console.log "new DirectoryView ----------===========+++++++:", @directory
    ...
    # console.log "directory view:@directory.squashedNames", @directory.squashedNames
...
DirectoryElement = document.registerElement('proj-view-directory', prototype: DirectoryView.prototype, extends: 'li')
